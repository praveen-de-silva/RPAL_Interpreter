// ================================
// Lexer.cpp
// Stage 1 of the RPAL interpreter pipeline.
//
// Reads the source file character by character and emits a flat
// token stream.  Every character is consumed exactly once.
// SPACES and COMMENT tokens are included here so the Screener
// can filter them as a separate, testable step.
// ================================
